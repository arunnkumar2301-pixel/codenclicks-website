...
export default function BlogHero() {
  return (
    <section className="relative overflow-hidden bg-[#111111] pt-40 pb-28 lg:pb-36">
      ...
      <div
        className="absolute top-0 right-0 z-10 w-[50vw] h-[55vh] opacity-[0.06] blur-[110px] pointer-events-none"
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <span className="text-[#C6A969]">inform</span>,
          <br />
          inspire, and grow brands.
        </motion.h1>
        ...
        >
          Explore perspectives on branding, SEO, digital marketing, web design,
          paid advertising, and growth strategy from the Code N Clicks team.
        </motion.p>
      </div>
    </section>
  );
