    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pt-4">
        <motion.nav
          ...
          className={`w-full max-w-6xl flex items-center justify-between px-5 py-3 rounded-2xl border transition-all duration-500 ${
            scrolled
              ? "bg-[#111111]/85 border-white/10 backdrop-blur-2xl shadow-2xl shadow-black/50"
              : "bg-[#111111]/50 border-white/10 backdrop-blur-md"
          }`}
        >
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="fixed top-[88px] left-4 right-4 z-40 bg-[#111111]/96 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl p-6"
          >
